...
<head>
    ...
    <style>
        ...
        * {
        ...
        .officer-profile:hover .officer-name {
            color: var(--text-primary);
        }
        ...
        .officer-profile.active .officer-icon {
            background: #dbeafe;
            color: #3b82f6;
        }
        ...
        .officer-profile.active .officer-name {
            color: var(--text-primary);
            font-weight: 600;
        }
        ...
        .officer-profile.active .officer-badge {
            color: #3b82f6;
        }
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="content-wrapper">
            ...
            <div style="margin-bottom: 20px;">
                <h2 style="font-size: 1.4rem; font-weight: 600; color: #1e293b; margin: 0 0 4px 0;">
                    <?= getGreeting() ?>, <?= htmlspecialchars($petugas1_nama) ?> &
                    <?= htmlspecialchars($petugas2_nama) ?>!
                </h2>
                <p style="font-size: 0.9rem; color: #64748b; margin: 0;"><?= tanggal_indonesia(date('Y-m-d')) ?></p>
            </div>

            <?php if ($is_blocked): ?>
                <div class="alert-message">
                    <i class="fas fa-exclamation-triangle"></i>
                    <span>Semua layanan teller telah ditutup sementara. Silakan hubungi admin untuk informasi lebih
                        lanjut.</span>
                </div>
                ...
                <div class="marquee-container">
                    <div class="marquee-content">
                        <span class="alert-text">
                            <i class="fas fa-exclamation-triangle"></i>
                            <strong>PERINGATAN KEAMANAN:</strong> Mohon menjaga kerahasiaan username dan password akun
                            petugas masing-masing. Jangan pernah membagikan kredensial login Anda kepada siapapun.
                            Segera laporkan ke admin jika ada aktivitas mencurigakan pada akun Anda. Keamanan data
                                    ...
                                    <div class="transaction-item">
                                        <div class="transaction-info">
                                            ...
                                            <div class="transaction-details">
                                                <div class="transaction-name"><?= htmlspecialchars($trans['siswa_nama']) ?>
                                                </div>
    ...
    <script>
        window.sessionConfig = {
            timeout: <?php echo $_SESSION['session_timeout'] ?? 1800; ?>,
            logoutUrl: '<?= BASE_URL ?>/logout.php?reason=timeout'
        };
    </script>
    <script src="<?= BASE_URL ?>/assets/js/session_auto_logout.js"></script>
</body>
