<?php
/**
 * Data Riwayat Transaksi Petugas - Harmonized Version
 * File: pages/admin/data_riwayat_transaksi_petugas.php
 */
...
if (!empty($date_params))
    $stmt_cnt->bind_param($date_types, ...$date_params);
$stmt_cnt->execute();
$total_records = $stmt_cnt->get_result()->fetch_assoc()['total'];
$stmt_cnt->close();
...
if (!empty($date_params)) {
    $all_params = array_merge($date_params, [$per_page, $offset]);
...
<head>
    ...
    <title>Data Riwayat Transaksi Petugas | KASDIG</title>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="page-title-section">
            ...
            <div class="page-title-content">
                <h1 class="page-title">Riwayat Transaksi Petugas</h1>
                <p class="page-subtitle">Pantau semua transaksi yang ditangani petugas</p>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-text">
                    <h3>Daftar Transaksi Petugas</h3>
                    <p>Riwayat transaksi yang ditangani petugas</p>
                </div>
    ...
    <script>
        ...
        document.getElementById('resetBtn').addEventListener('click', () => {
            window.location.href = '<?= BASE_URL ?>/pages/admin/data_riwayat_transaksi_petugas.php';
        });
        ...
        pdfLink.addEventListener('click', function (e) {
            ...
            setTimeout(() => {
                ...
                let url = '<?= BASE_URL ?>/pages/admin/download_laporan_petugas.php?format=pdf';
