<?php
/**
 * Download Laporan Transaksi Admin - Portrait Version
 * File: pages/admin/download_laporan_admin.php
 * 
 * Style matching export_laporan_pdf.php (bendahara)
 * Data from data_riwayat_transaksi_admin.php
 */
...
// Query harus sama dengan data_riwayat_transaksi_admin.php
$sql_data = "SELECT 
                t.created_at,
                t.jumlah,
                t.jenis_transaksi,
             ...
             AND (t.petugas_id IS NULL OR p.role = 'admin')
             AND $where_sql
...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('Laporan Transaksi Admin');
...
$pdf->Cell(0, 8, 'LAPORAN TRANSAKSI ADMIN', 0, 1, 'C');
...
$pdf->MultiCell(0, 5, 'Keterangan: Data ini merupakan transaksi yang dilakukan siswa langsung lewat KASDIG (tanpa petugas).', 0, 'L');

// === OUTPUT PDF ===
$filename = 'Laporan_Transaksi_Admin_' . date('Y-m-d_His') . '.pdf';
