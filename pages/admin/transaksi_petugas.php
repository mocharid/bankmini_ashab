...
// Ambil data transaksi berdasarkan filter tanggal - KOSONG DEFAULT
$start_date = $_GET['start_date'] ?? '';
$end_date = $_GET['end_date'] ?? '';

// Pagination settings - UBAH MENJADI 15
$items_per_page = 15;
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="summary-container">
            <h3 class="summary-title"><i class="fas fa-chart-line"></i> Ringkasan Transaksi Petugas</h3>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p class="empty-state-message">
                        Tidak ditemukan transaksi petugas dalam periode yang dipilih. Silakan periksa filter tanggal atau coba periode lain.
                    </p>
                </div>
            <?php endif; ?>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pdfButton) {
                pdfButton.addEventListener('click', function(e) {
                    ...
                    let url = `download_laporan_petugas.php?format=pdf`;
