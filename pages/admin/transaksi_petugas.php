<?php
/**
 * Laporan Transaksi Petugas - Final Version
 * File: pages/admin/transaksi_petugas.php
 */
...
$total_query = "SELECT
    ...
    WHERE t.jenis_transaksi IN ('setor','tarik')
      AND t.petugas_id IS NOT NULL" . $date_where;
...
<head>
    ...
    <title>Transaksi Petugas | MY Schobank</title>
...
<body>
    ...
    <div class="main-content" id="mainContent">
        <div class="welcome-banner">
            ...
            <div>
                <h2>Data Transaksi Petugas</h2>
                <p>Lihat dan kelola data transaksi petugas secara terpusat</p>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById('resetBtn').addEventListener('click', () => {
            window.location.href = '<?= BASE_URL ?>/pages/admin/transaksi_petugas.php';
        });
