...
try {
    ...
    error_log("Database error in rekapitulasi_transaksi.php: " . $e->getMessage());
...
// Query transaksi lengkap dengan join ke tabel users sebagai petugas
try {
    $query = "SELECT 
        t.no_transaksi,
        t.jenis_transaksi,
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="summary-container">
            <h3 class="summary-title"><i class="fas fa-chart-line"></i> Ringkasan Rekapitulasi Transaksi</h3>
                    ...
                    <table class="transaction-table">
                        ...
                        <tbody>
                            <?php foreach ($transactions as $index => $transaction): ?>
                                ...
                                $nama_petugas = trim($transaction['nama_petugas_real'] ?? '') ?: 'Admin';
                                ?>
                                <tr>
                                    <td><?= $noUrut ?></td>
                                    ...
                                    <td><?= $nama_kelas ?></td>
                                    <td><span class="transaction-type"><?= $displayType ?></span></td>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p class="empty-state-message">
                        Tidak ditemukan transaksi dalam periode yang dipilih. Silakan periksa filter tanggal atau coba periode lain.
                    </p>
                </div>
            <?php endif; ?>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pdfButton) {
                pdfButton.addEventListener('click', function(e) {
                    ...
                    let url = `download_rekap_transaksi.php?format=pdf`;
