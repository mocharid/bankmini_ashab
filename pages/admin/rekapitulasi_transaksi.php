...
if (!empty($date_params)) $stmt_total->bind_param($date_types, ...$date_params);
$stmt_total->execute();
...
if (!empty($date_params)) $stmt_cnt->bind_param($date_types, ...$date_params);
$stmt_cnt->execute();
...
<head>
    ...
    <title>Rekapitulasi Transaksi | MY Schobank</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Poppins',sans-serif; }
        ...
        .summary-item h4 { font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 5px; }
        .summary-item p { font-size: 1.2rem; font-weight: 600; color: var(--primary-color); margin: 0; }
...
<body>
    ...
    <div class="main-content" id="mainContent">
        <div class="welcome-banner">
            ...
            <div>
                <h2>Data Rekapitulasi Transaksi</h2>
                <p>Lihat dan kelola data rekapitulasi transaksi secara terpusat</p>
            </div>
        </div>
        ...
        <div class="jadwal-list">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                <h3>Daftar Rekapitulasi Transaksi</h3>
                ...
                <table>
                    ...
                    <tbody>
                        <?php if (empty($transactions)): ?>
                            <tr><td colspan="9" style="text-align:center; padding:30px; color:#999;">Belum ada data transaksi.</td></tr>
                        <?php else: ?>
                            <?php $no = $offset + 1; ?>
