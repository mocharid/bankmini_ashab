        ...
        <div class="summary-container">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>T rampant ada transaksi admin dalam periode ini</p>
                </div>
            <?php endif; ?>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pdfButton) {
                pdfButton.addEventListener('click', function(e) {
                    ...
                    const url = `download_laporan_admin.php?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}&format=pdf`;
